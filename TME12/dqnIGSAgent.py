...
if __name__ == '__main__':
    ...
    #---environment---#
    config = load_yaml('./configs/config_random_gridworldIGS.yaml')
    ...
    G = deque(maxlen=10)
    N = defaultdict(lambda: 0) # store the number of tries to reach g
    V = defaultdict(lambda: 0) # store the number of times it managed to reach g
