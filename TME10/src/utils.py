...
def write_epoch(writer, mr, epoch, test):
    cat = 'test' if test else 'train'
    for i in range(len(mr)):
        writer.add_scalar(f'rewards/{cat}/agent{i}', float(mr[i]), epoch)
    writer.add_scalar(f'rewards/{cat}/total/', float(sum(mr)), epoch)
